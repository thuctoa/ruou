...
use Yii;
use backend\models\Tuyendungnhansu;
use backend\models\TuyendungnhansuSearch;
...
class TuyendungnhansuController extends Controller
{
    ...
    {
        $searchModel = new TuyendungnhansuSearch();
    ...
    /**
     * Displays a single Tuyendungnhansu model.
     * @param integer $id
     * @return mixed
     */
