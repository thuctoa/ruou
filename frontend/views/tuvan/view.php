...
<div class="breadcrumb-page">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="?r=tuvan">Tư vấn các giải pháp công nghệ tối ưu hóa quá trình sản xuất</a></li>
        
         <li class="active"><a href="?r=tuvan%2Fview&id=<?=$tuvan->tuvan_id?>"><?= $tuvan->tuvan_tieude?></a></li>
    </ol><!--end breadcrumb-->
</div>
<div class="content-catogery">
    ...
    <div class="col-sm-9">
        <div class="detail-new">
             <h1><?= $tuvan->tuvan_tieude?></h1>
            <div class="content-new">
                <div class="tuvan-index" style="position: relative;bottom: 66px;">
                    <br>
