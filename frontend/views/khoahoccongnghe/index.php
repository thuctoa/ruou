...
<div class="content-catogery">
    ...
    <div class="col-sm-9">
        <div class="new">
            <?php
            foreach ($khoahoccongnghe as $khoahoccongnghe){
                $anh=$khoahoccongnghe->baiviet_anh;
                $tieude=$khoahoccongnghe->baiviet_tieude;
                $gioithieu=$khoahoccongnghe->baiviet_gioithieu;
                $id=$khoahoccongnghe->baiviet_id;
            ?>
            <div class="list-new">
                <a href="#" ><img src="<?=$anh?>" class="imgstyle"> </a>
                <h2><a href="?r=khoahoccongnghe%2Fview&id=<?=$id?>"><?=$tieude?></a> </h2>
                <p>
                   <?=$gioithieu?>
                </p>
            </div>
