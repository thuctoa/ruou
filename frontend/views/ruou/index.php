...
<div class="content-catogery">
    ...
    <div class="col-sm-9">
        <div class="product-category">
            <div class="col-sm-4">
                <?php
                foreach ($ruou as $ruou){
                    $anh=$ruou->ruou_anh;
                    $noidung=$ruou->ruou_noidung;
                    $ten=$ruou->ruou_tieude;
                    $id=$ruou->ruou_id;
               
                ?>
                <div class="item-product-category">
                    <h2><a href="?r=ruou%2Fview&id=<?=$id?>"><?=$ten?></a> </h2>
                    <div class="p-images">
                        <a href="?r=ruou%2Fview&id=<?=$id?>"><img src="<?=$anh?>" alt="Filter"></a>
                    </div>
                    <span class="more"><a href="?r=ruou%2Fview&id=<?=$id?>"> <span class="more">Chi tiết</span></a></span>
                </div>
                  <?php
