...
<div class="breadcrumb-page">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="?r=sanpham">Sản phẩm</a></li>
          <li class="active"><a href="?r=ruou">Rượu</a></li>
                   <li class="active"><a href="?r=ruou%2Fview&id=<?=$ruou->ruou_id?>"><?=$ruou->ruou_tieude?></a></li>
    </ol><!--end breadcrumb-->
</div>
        ...
        <div class="product-detail">
            <div class="box-des">
                ...
                <div class="img-mobile">
                    <img src="<?=$ruou->ruou_anh?>">
                </div>
                <div class="slider-images">
                    <div class="simpleLens-gallery-container" id="zoomimages">
                        <div class="simpleLens-container">
                            <div class="simpleLens-big-image-container">
                                <a class="simpleLens-lens-image" data-lens-image="/<?=$ruou->ruou_anh?>">
                                    <img src="<?=$ruou->ruou_anh?>" class="simpleLens-big-image">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="simpleLens-thumbnails-container">
                            ...
                            <a href="#" class="simpleLens-thumbnail-wrapper"
                               data-lens-image="<?=$ruou->ruou_anh?>"
                               data-big-image="<?=$ruou->ruou_anh?>">
                                <img src="<?=$ruou->ruou_anh?>">
                            </a>
                        </div>
                    </div>
                ...
                <div class="listproduct-other">
                    <div class="col-sm-4">
                        <div class="item-product-category">
                            <div class="p-images">
                                <a href="#"><img src="<?=$ruou->ruou_anh?>" alt="Filter"></a>
                            </div>
