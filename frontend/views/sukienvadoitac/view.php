...
$this->title = $sukienvadoitac->baiviet_tieude;
...
<div class="breadcrumb-page">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="?r=tintuc">Tin tức</a></li>
         ...
         <li class="active"><a href="r=sukienvadoitac%2Fview&id=<?=$sukienvadoitac->baiviet_id?>"><?= $sukienvadoitac->baiviet_tieude?></a></li>
    </ol><!--end breadcrumb-->
</div>
<div class="content-catogery">
    ...
    <div class="col-sm-9">
        <div class="detail-new">
             <h1><?= $sukienvadoitac->baiviet_tieude?></h1>
            <div class="content-new">
                <div class="tintuc-index" style="position: relative;bottom: 66px;">
                    ...
                    <br>
                    <br>
                    <?= $sukienvadoitac->baiviet_noidung ?>
