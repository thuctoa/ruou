...
$this->title = $nghiencuu->nghiencuu_tieude;
...
<div class="breadcrumb-page">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="?r=nghiencuu">Nghiên cứu khoa học và chuyển giao công nghệ</a></li>
         ...
         <li class="active"><a href="?r=nghiencuu%2Fview&id=<?=$nghiencuu->nghiencuu_id?>"><?= $nghiencuu->nghiencuu_tieude?></a></li>
    </ol><!--end breadcrumb-->
</div>
<div class="content-catogery">
    ...
    <div class="col-sm-9">
        <div class="detail-new">
             <h1><?= $nghiencuu->nghiencuu_tieude?></h1>
            <div class="content-new">
                <div class="nghiencuu-index" style="position: relative;bottom: 66px;">
                    <br>
               
                    <br>
                    <br>
                    <?= $nghiencuu->nghiencuu_noidung ?>
