...
<div class="content-catogery">
    ...
    <div class="col-sm-9">
        <div class="product-category">
            <div class="col-sm-4">
                <?php
                foreach ($sanphamkhac as $sanphamkhac){
                    $anh=$sanphamkhac->sanphamkhac_anh;
                    $noidung=$sanphamkhac->sanphamkhac_noidung;
                    $ten=$sanphamkhac->sanphamkhac_tieude;
                    $id=$sanphamkhac->sanphamkhac_id;
               
                ?>
                <div class="item-product-category">
                    <h2><a href="?r=sanphamkhac%2Fview&id=<?=$id?>"><?=$ten?></a> </h2>
                    <div class="p-images">
                        <a href="?r=sanphamkhac%2Fview&id=<?=$id?>"><img src="<?=$anh?>" alt="Filter"></a>
                    </div>
                    <span class="more"><a href="?r=sanphamkhac%2Fview&id=<?=$id?>"> <span class="more">Chi tiết</span></a></span>
                </div>
                  <?php
