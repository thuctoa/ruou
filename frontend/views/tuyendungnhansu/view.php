...
$this->title = $tuyendungnhansu->baiviet_tieude;
...
<div class="breadcrumb-page">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="?r=tuyendungnhansu">Tuyển dụng nhân sự</a></li>
         <li class="active"><a href="?r=tuyendungnhansu%2Fview&id=<?=$tuyendungnhansu->baiviet_id?>"><?= $tuyendungnhansu->baiviet_tieude?></a></li>
    </ol><!--end breadcrumb-->
</div>
<div class="content-catogery">
    ...
    <div class="col-sm-9">
        <div class="detail-new">
             <h1><?= $tuyendungnhansu->baiviet_tieude?></h1>
            <div class="content-new">
                <div class="tintuc-index" style="position: relative;bottom: 66px;">
                    ...
                    <br>
                    <br>
                    <?= $tuyendungnhansu->baiviet_noidung ?>
