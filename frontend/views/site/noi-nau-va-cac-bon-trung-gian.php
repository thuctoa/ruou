        ...
        <div class="product-detail">
            <div class="box-des">
                ...
                <div class="img-mobile">
                    <img src="/images/machine/Nồi nấu và các bồn trung gian.jpg">
                </div>
                <div class="slider-images">
                    <div class="simpleLens-gallery-container" id="zoomimages">
                        <div class="simpleLens-container">
                            <div class="simpleLens-big-image-container">
                                <a class="simpleLens-lens-image" data-lens-image="/images/machine/Nồi nấu và các bồn trung gian.jpg">
                                    <img src="/images/machine/Nồi nấu và các bồn trung gian.jpg" class="simpleLens-big-image">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="simpleLens-thumbnails-container">
                            ...
                            <a href="#" class="simpleLens-thumbnail-wrapper"
                               data-lens-image="/images/machine/Nồi nấu và các bồn trung gian.jpg"
                               data-big-image="/images/machine/Nồi nấu và các bồn trung gian.jpg">
                                <img src="/images/machine/Nồi nấu và các bồn trung gian.jpg">
                            </a>
                        </div>
                    </div>
                ...
                <div class="product-detail-des">
                    <h2>Nồi nấu và các bồn trung gian</h2>
                    <br class="space"/>
                    ...
                    <p>Công ty Cổ phần Thực phẩm Vinastar (KCN Đông Thọ, huyện Yên Phong, tỉnh Bắc Ninh)</p>
                    <br class="space"/>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="tab1">
                        <div class="list-new">
                            ...
                            <h2><a href="?r=site/hinh-anh-thiet-bi-trien-khai-1">Một số thiết bị và các dự án đã triển khai - phần 1</a> </h2>
                            <p>Hình ảnh một số thiết bị và các dự án đã triển khai</p>
                        </div>
                        <div class="list-new">
                            <a href="#"><img src="/images/anh-bai-viet.jpg"  class="imgstyle"> </a>
                            <h2><a href="?r=site/hinh-anh-thiet-bi-trien-khai-2">Một số thiết bị và các dự án đã triển khai - phần 2</a> </h2>
                            <p>Hình ảnh một số thiết bị và các dự án đã triển khai</p>
                        </div>
                        <div class="list-new">
                            <a href="#"><img src="/images/anh-bai-viet.jpg"  class="imgstyle"> </a>
                            <h2><a href="?r=site/hinh-anh-thiet-bi-trien-khai-3">Một số thiết bị và các dự án đã triển khai - phần 3</a> </h2>
                            <p>Hình ảnh một số thiết bị và các dự án đã triển khai</p>
                        </div>
                    </div>
                ...
                <div class="listproduct-other">
                    <div class="col-sm-4">
                        <div class="item-product-category">
                            <div class="p-images">
                                <a href="#"><img src="/images/machine/Nồi nấu và các bồn trung gian.jpg" alt="Filter"></a>
                            </div>
                            <h2><a href="#">Nồi nấu và các bồn trung gian</a> </h2>
