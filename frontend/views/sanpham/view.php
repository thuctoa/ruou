...
$this->title = $sanpham->sanpham_ten;
        ...
        <div class="product-detail">
            <div class="box-des">
                ...
                <div class="img-mobile">
                    <img src="<?=$sanpham->sanpham_anh?>">
                </div>
                <div class="slider-images">
                    <div class="simpleLens-gallery-container" id="zoomimages">
                        <div class="simpleLens-container">
                            <div class="simpleLens-big-image-container">
                                <a class="simpleLens-lens-image" data-lens-image="/<?=$sanpham->sanpham_anh?>">
                                    <img src="<?=$sanpham->sanpham_anh?>" class="simpleLens-big-image">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="simpleLens-thumbnails-container">
                            ...
                            <a href="#" class="simpleLens-thumbnail-wrapper"
                               data-lens-image="<?=$sanpham->sanpham_anh?>"
                               data-big-image="<?=$sanpham->sanpham_anh?>">
                                <img src="<?=$sanpham->sanpham_anh?>">
                            </a>
                        </div>
                    </div>
                ...
                <div class="listproduct-other">
                    <div class="col-sm-4">
                        <div class="item-product-category">
                            <div class="p-images">
                                <a href="#"><img src="<?=$sanpham->sanpham_anh?>" alt="Filter"></a>
                            </div>
