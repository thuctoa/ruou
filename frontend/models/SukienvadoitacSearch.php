...
/**
 * SukienvadoitacSearch represents the model behind the search form about `frontend\models\Sukienvadoitac`.
 */
class SukienvadoitacSearch extends Sukienvadoitac
{
    /**
     * @inheritdoc
     */
